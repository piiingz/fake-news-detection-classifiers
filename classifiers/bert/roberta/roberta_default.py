...
if __name__ == '__main__':
    ...
    if is_weak_supervised:
        ...
        model_args.output_dir = 'outputs/roberta_default/weak_supervised/'
        model_args.best_model_dir = 'outputs/roberta_default/weak_supervised/best_model'
        ...
        model_args.output_dir = 'outputs/roberta_default/supervised/'
        model_args.best_model_dir = 'outputs/roberta_default/supervised/best_model'
