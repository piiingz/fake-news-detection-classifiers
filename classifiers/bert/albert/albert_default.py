...
if __name__ == '__main__':
    ...
    if is_weak_supervised:
        ...
        model_args.output_dir = 'outputs/albert_default/weak_supervised/'
        model_args.best_model_dir = 'outputs/albert_default/weak_supervised/best_model'
        ...
        model_args.output_dir = 'outputs/albert_default/supervised/'
        model_args.best_model_dir = 'outputs/albert_default/supervised/best_model'
