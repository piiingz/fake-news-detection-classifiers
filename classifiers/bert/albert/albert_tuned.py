...
if __name__ == '__main__':
    ...
    if is_weak_supervised:
        ...
        model_args.learning_rate = 0.00003246

        model_args.output_dir = 'outputs/albert_tuned/weak_supervised/'
        model_args.best_model_dir = 'outputs/albert_tuned/weak_supervised/best_model'
        ...
        model_args.learning_rate = 0.00004609

        model_args.output_dir = 'outputs/albert_tuned/supervised/'
        model_args.best_model_dir = 'outputs/albert_tuned/supervised/best_model'
