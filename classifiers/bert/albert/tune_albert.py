...
from handle_datasets.load_datasets import load_weak_bert_tuning, load_supervised_bert_tuning
...
if is_weak_supervised:
    train_df, eval_df, test_df = load_weak_bert_tuning()
    model_setting = 'weak'
    output_subdir = 'weak_supervised/'

else:
    train_df, eval_df, test_df = load_supervised_bert_tuning()
...
# Configuring sweep
sweep_config = {
    "name": "albert-"+model_setting+"-sweep-batch-32",
    "method": "bayes",
...
model_args.output_dir = 'outputs/tune_albert/' + output_subdir
model_args.best_model_dir = 'outputs/tune_albert/' + output_subdir + 'best_model'
